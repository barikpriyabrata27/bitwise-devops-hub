...
| --------- | --------------------- | ---- |
| C# | Minimal API + xUnit tests, full Build → Security → Zipping → Release pipeline (the reference implementation for this knowledge base) | [bitwise-devops-csharp](https://github.com/barikpriyabrata27/bitwise-devops-csharp) |
